  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="container mx-auto px-4">
        ...
        {undoAction && (
          <div className="max-w-4xl mb-6 p-4 bg-slate-100 border border-slate-200 rounded-lg">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-4">
              ...
              <button
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors mb-3"
              >
                Оформити замовлення
              </button>
